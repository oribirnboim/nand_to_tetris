...
class Parser:
    ...
    def command_type(self) -> str:
        ...
        if self.current_command[0] == 'return': return 'C_RETURN'
        ...
        if cmd_type == 'goto': return 'C_GOTO'
        if cmd_type == 'if-goto': return 'C_IF'
        if cmd_type == 'function': return 'C_FUNCTION'
        if cmd_type == 'call': return 'C_CALL'
        if cmd_type == 'return': return 'C_RETURN'
        return 'C_LABEL'
